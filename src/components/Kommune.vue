<template>
    ...
    <section>
        <div class="text-container lighter">
            <h2>Støtteperson til forældre, hvis barn er anbragt udenfor hjemmet (§ 75)</h2>
            <p>{{ stoetteText }}</p>
        </div>
    </section>
    <section>
        <div class="text-container light">
            <h2>Støtte til samvær</h2>
            <p>{{ samvaerText }}</p>
        </div>
    </section>
    <section>
...
<script setup>
import familieText from '@/content/familiebehandling.txt?raw'
